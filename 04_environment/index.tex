...
Figure~\ref{fig:Distribution of Foraging returns Deer Hunting} represents the return utility which represents the return multiplier of the foraging. The average \textbf{expected mean} return across $1000$ iterations is shown by the colourful lines which is close to the \textbd{real mean}.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=1\textwidth]{04_nvironment/Images/Distribution of Foraging returns Fishing.PNG}
