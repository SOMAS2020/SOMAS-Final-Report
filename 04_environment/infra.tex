...
The minimum collective resource input needed to hunt $n$ deer, $x_{min}$, can be calculated as the cumulative cost given by
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=1\textwidth]{04_environment_infra/images/deer_pop_prob.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=1\textwidth]{04_environment_infra/images/Disaster Effects Outcome.PNG}
...
\end{tabular}
\end{center}
\caption{Main funcitions of Common Pool for Disaster Mitigation}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=1\textwidth]{04_environment_infra/images/Common Pool infrastructure outcome.PNG}
